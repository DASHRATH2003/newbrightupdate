...
export default function Investor() {
  return (
    ...
    <div className="accordion">
        ...
        />
          ...
          content={
            <ul>
              ...
              <li>Check for SEBI registration number. Please refer to the list of all SEBI registered Research Analyst which is available on SEBI website in the following <a href="https://www.sebi.gov.in/sebiweb/other/OtherAction.do?doRecognisedFpi =yes&intmId=14.">https://scores.sebi.gov.in</a></li>
      ...
      <a> <h3 style={{color:"green"}}> Research Analyst (RA)</h3> <h6>:ANITHA M PROPRIETOR OF BRIGHTWAYS FINANCIAL SERVICES: INH000010566</h6></a>
       
    
      <p>For details about Customer Support, Compliance Officer, Research Services, Risk Disclosures, Disclaimers, Refund Policies, Terms and Conditions, and Others, visit our website: <a href=" https://www.brightwaysfinancial.com/">https://www.brightwaysfinancial.com</a> </p>
